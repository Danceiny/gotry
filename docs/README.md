...
| [evaluation/clean-consumer-boot-diagnostics-report.md](evaluation/clean-consumer-boot-diagnostics-report.md) | Clean-consumer SDK boot diagnostics: phase/hook records, bounded-tail root cause, and a bounded reproduction campaign (#511) |
