...
| [design/itinerary-html-renderer.md](design/itinerary-html-renderer.md) | Itinerary HTML renderer contract (internal slice, issue #442/parent #438): pure bounded renderer, plan plane vs evidence plane, rejection set; not yet wired into the product chain |
