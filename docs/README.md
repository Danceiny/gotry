...
| [evaluation/round12-canary-report.md](evaluation/round12-canary-report.md) | Round 12 frozen canary run report: what ran, what the scores mean, per-constraint findings (issue #203/#215 closure) |
