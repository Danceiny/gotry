...
| D-9 节日锚点表硬编码 | **2026-08-28 扩表清偿，2026-09-11（#274）再扩**：SPRING_FESTIVAL 覆盖 2026-2040，逐条为农历正月初一天文日期（非国务院放假安排口径——后者只提前约一年公布；表外年份不预估、不编造）。来源=香港天文台公历↔农历转换表（hko.gov.hk，`T2032e`-`T2040e` 于 2026-09-11 逐条核对，并与 Wikipedia「Chinese New Year」日期表交叉一致）。回归闸：time-eval §1b（2030 锚点断言 2031 春节）与 §1c（2031 边界、首个新年 2032-02-11、闰年/年际过渡周行、地平线末日与越界已知缺失）。**已验证地平线=2040-02-12，须在该日前再扩表**（建议 2039-Q4 巡检），否则春节锚点静默缺失（公开追踪 = [#274](https://github.com/Danceiny/gotry/issues/274)） |
