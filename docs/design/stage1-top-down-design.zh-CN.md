...
> **状态速览**：
- 2026-09-13 起，内嵌 Booking Copilot personaPrefix 已到达首次外发的 DSH 模型请求（#467）；#470 将 safe-ref 语法投射到面向模型的 tool schema，支持同 run typed 纠偏并保留 unsafe ref 的 fail-closed。本条仅为本地工程证明，真实 Booking UAT 仍属 #142。
