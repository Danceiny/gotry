...
Not in any slice: static hosting/deploy, any runtime activation, and any share/consent surface (Phase C slice at issue #573) — all later slices of issue #564. The deck renderer only renders caller-supplied structure plus registry-selected facts; its fixtures are synthetic and stand for no supplier evidence.
