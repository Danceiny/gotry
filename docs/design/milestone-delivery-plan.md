...
- **Exit criteria**: the WriteGate proposal entered main with PR #249 (merge 293bbb6), as a design input only before M5 implementation; implementation/UAT/M5 Entry remain TODO (#136/#231/#232/#233), and the transaction runtime stays sealed.
