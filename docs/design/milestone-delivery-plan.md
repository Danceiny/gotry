...
- **Exit criteria**: The WriteGate proposal and the #231 pre-entry core are in main. M5 Entry still requires M4 Exit plus the supply agreement (#136). Runtime activation and qualifying real supplier UAT (#136/#142) follow only after Entry; M5 Exit remains subject to its original acceptance criteria.
