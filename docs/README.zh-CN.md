...
| [evaluation/clean-consumer-boot-diagnostics-report.zh-CN.md](evaluation/clean-consumer-boot-diagnostics-report.zh-CN.md) | 干净消费端 SDK 启动诊断：阶段／钩子记录、有界尾部保留根因与有界复现尝试（#511） |
