<!--
感谢 PR!提交前请读 CONTRIBUTING.md。合并条件:CI 全绿(Node 22/24,typecheck + §1-§32)+ 维护者 review。
Thanks for your PR! Merging requires green CI (Node 22/24, typecheck + full regression §1-§32) plus maintainer review.
-->
...
- [ ] 本地全栈回归全绿(`./scripts/run-all-tests.sh`,§1-§32)
