...
const ALIASES: Record<string, BookingTypedErrorCode> = {
  ...
  planner_provider_auth_failed: 'PLANNER_PROVIDER_AUTH_FAILED',
  planner_provider_quota_exhausted: 'PLANNER_PROVIDER_QUOTA_EXHAUSTED',
  planner_provider_rate_limited: 'PLANNER_PROVIDER_RATE_LIMITED',
  planner_provider_unavailable: 'PLANNER_PROVIDER_UNAVAILABLE',
  planner_provider_request_rejected: 'PLANNER_PROVIDER_REQUEST_REJECTED',
  planner_provider_response_invalid: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_provider_timeout: 'PLANNER_PROVIDER_TIMEOUT',
  planner_boot_timeout: 'PLANNER_BOOT_TIMEOUT',
  planner_configuration_invalid: 'PLANNER_CONFIGURATION_INVALID',
  planner_failed: 'PLANNER_FAILED',
  planner_invalid_tool_arguments: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_invalid_typed_decision: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_invalid_action: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_booking_intent_required: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_invalid_booking_intent: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_ambiguous_booking_intent: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_multiple_typed_decisions: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_typed_decision_after_candidate: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_typed_decision_missing: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_unresolved_tool_call_before_candidate: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_call_duplicate_call_id: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_call_missing_call_id: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_call_rejected: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_result_malformed: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_result_out_of_order: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_tool_result_unmatched: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_checkpoint_mismatch: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_checkpoint_unavailable: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_intent_criteria_unachieved: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_intent_target_unachieved: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_intent_unjustified: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_search_checkpoint_mismatch: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_search_patch_not_ready: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_search_results_not_ready: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_terminal_search_workspace_mismatch: 'PLANNER_PROVIDER_RESPONSE_INVALID',
  planner_forbidden_action: 'UNSUPPORTED_ACTION',
  planner_forbidden_tool: 'UNSUPPORTED_ACTION',
  planner_capability_action_mismatch: 'UNSUPPORTED_ACTION',
  planner_intent_target_unsupported: 'PLANNER_SURFACE_ACTION_UNSUPPORTED',
  planner_context_mismatch: 'CONTEXT_MISMATCH',
  planner_revision_mismatch: 'STALE_REVISION',
  booking_intent_required: 'INVALID_ACTION',
  invalid_booking_intent: 'INVALID_ACTION',
  action_intent_mismatch: 'INVALID_ACTION',
  intent_mutation_forbidden: 'INVALID_ACTION',
...
const SAFE_MESSAGES: Record<BookingTypedErrorCode, string> = {
  ...
  PLANNER_PROVIDER_TIMEOUT: 'The planner did not respond within the booking turn deadline.',
  PLANNER_BOOT_TIMEOUT: 'The planner runtime did not finish starting within its local boot budget.',
  PLANNER_CONFIGURATION_INVALID: 'The planner provider configuration is invalid.',
  PLANNER_FAILED: 'The planner stopped unexpectedly before producing a usable action.',
