window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".QG_wHa_root{min-width:0;position:relative}.QG_wHa_trigger{min-width:0;max-width:min(360px,45cqw);height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.QG_wHa_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.QG_wHa_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.QG_wHa_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.QG_wHa_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.QG_wHa_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.QG_wHa_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.QG_wHa_chevronOpen{transform:rotate(180deg)}.QG_wHa_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:max-content;min-width:min(240px,100vw - 32px);max-width:min(420px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.QG_wHa_status,.QG_wHa_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.QG_wHa_error,.QG_wHa_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.QG_wHa_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.QG_wHa_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.QG_wHa_groups{min-height:0;overflow-y:auto}.QG_wHa_group+.QG_wHa_group{margin-top:4px}.QG_wHa_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.QG_wHa_option{box-sizing:border-box;width:auto;min-width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.QG_wHa_option:hover:not(:disabled),.QG_wHa_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.QG_wHa_selected{background:0 0}.QG_wHa_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.QG_wHa_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.QG_wHa_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.QG_wHa_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.QG_wHa_cell{box-sizing:border-box;width:auto;min-width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.QG_wHa_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.QG_wHa_cellLabel{white-space:nowrap;flex:none}.QG_wHa_cellValue{text-overflow:ellipsis;white-space:nowrap;text-align:right;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.QG_wHa_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"cell": "QG_wHa_cell",
			"cellChevron": "QG_wHa_cellChevron",
			"cellLabel": "QG_wHa_cellLabel",
			"cellValue": "QG_wHa_cellValue",
			"check": "QG_wHa_check",
			"chevron": "QG_wHa_chevron",
			"chevronOpen": "QG_wHa_chevronOpen",
			"empty": "QG_wHa_empty",
			"error": "QG_wHa_error",
			"group": "QG_wHa_group",
			"groupTitle": "QG_wHa_groupTitle",
			"groups": "QG_wHa_groups",
			"menu": "QG_wHa_menu",
			"modelName": "QG_wHa_modelName",
			"option": "QG_wHa_option",
			"optionCopy": "QG_wHa_optionCopy",
			"retry": "QG_wHa_retry",
			"root": "QG_wHa_root",
			"selected": "QG_wHa_selected",
			"status": "QG_wHa_status",
			"trigger": "QG_wHa_trigger",
			"triggerEffort": "QG_wHa_triggerEffort",
			"triggerLabel": "QG_wHa_triggerLabel",
			"warning": "QG_wHa_warning"
		};
		//#endregion
