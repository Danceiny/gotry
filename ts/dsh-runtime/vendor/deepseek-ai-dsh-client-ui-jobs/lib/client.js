window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-jobs/src/client/JobListAction.module.css.mjs
		const css = ".nUFduW_root{position:relative}.nUFduW_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.nUFduW_trigger:hover,.nUFduW_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.nUFduW_trigger svg{transition:transform .12s}.nUFduW_triggerOpen{transform:rotate(180deg)}.nUFduW_triggerDot{flex:none}.nUFduW_count{margin:0 5px}.nUFduW_menu{z-index:100;box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(420px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;gap:1px;margin:0;padding:4px;list-style:none;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.nUFduW_row{box-sizing:border-box;width:100%;min-height:32px;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:13px;line-height:18px;display:flex}.nUFduW_rowSettled{color:var(--dsw-alias-label-tertiary)}.nUFduW_rowDot{flex:none}.nUFduW_kind{background:var(--dsw-alias-fill-l2);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 6px;font-size:11px;line-height:18px}.nUFduW_label{min-width:0;font-family:var(--dsw-font-mono);white-space:nowrap;text-overflow:ellipsis;flex:1;overflow:hidden}.nUFduW_status,.nUFduW_duration{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;line-height:18px}.nUFduW_status{white-space:nowrap;text-overflow:ellipsis;max-width:40%;overflow:hidden}.nUFduW_duration{font-variant-numeric:tabular-nums}";
		...
		var JobListAction_module_css_default = {
			"count": "nUFduW_count",
			"duration": "nUFduW_duration",
			"kind": "nUFduW_kind",
			"label": "nUFduW_label",
			"menu": "nUFduW_menu",
			"root": "nUFduW_root",
			"row": "nUFduW_row",
			"rowDot": "nUFduW_rowDot",
			"rowSettled": "nUFduW_rowSettled",
			"status": "nUFduW_status",
			"trigger": "nUFduW_trigger",
			"triggerDot": "nUFduW_triggerDot",
			"triggerOpen": "nUFduW_triggerOpen"
		};
		//#endregion
