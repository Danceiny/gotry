window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/client/AppearanceRow.module.css.mjs
		const css$1 = ".Dboi6W_group{border-bottom:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:8px;padding:16px 0;display:flex}.Dboi6W_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Dboi6W_cubeRow{flex-wrap:wrap;align-items:stretch;gap:8px;display:flex}.Dboi6W_themeCube{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:16px;flex-direction:column;flex:180px;justify-content:center;align-items:center;gap:4px;padding:20px 32px;font-size:14px;line-height:22px;display:flex}.Dboi6W_themeCube:hover:not(.Dboi6W_selected){background:var(--dsw-alias-interactive-bg-hover)}.Dboi6W_selected{background:var(--dsw-alias-bg-module-platform);border-color:var(--dsw-static-neutral-bluish-400)}";
		...
		var AppearanceRow_module_css_default = {
			"cubeRow": "Dboi6W_cubeRow",
			"group": "Dboi6W_group",
			"selected": "Dboi6W_selected",
			"themeCube": "Dboi6W_themeCube",
			"title": "Dboi6W_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/client/FontSizeRow.module.css.mjs
		const css = ".iWayra_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.iWayra_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.iWayra_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.iWayra_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.iWayra_control{align-items:center;gap:8px;display:inline-flex}.iWayra_stepper{background:var(--dsw-alias-bg-module-platform);border-radius:18px;justify-content:center;align-items:center;min-width:72px;height:36px;display:inline-flex;position:relative}.iWayra_value{text-align:center;font-variant-numeric:tabular-nums;min-width:18px;color:var(--dsw-alias-label-primary);font-size:14px;line-height:22px}.iWayra_unit{color:var(--dsw-alias-label-secondary);font-size:14px;line-height:22px}.iWayra_arrows{opacity:0;flex-direction:column;gap:2px;display:flex;position:absolute;right:8px}.iWayra_stepper:hover .iWayra_arrows,.iWayra_stepper:focus-within .iWayra_arrows{opacity:1}.iWayra_arrow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-1) 75%, transparent);width:17px;height:12px;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:3px;justify-content:center;align-items:center;padding:0;display:inline-flex}.iWayra_arrow:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.iWayra_arrow:disabled{color:var(--dsw-alias-label-caption);cursor:default}";
		...
		var FontSizeRow_module_css_default = {
			"arrow": "iWayra_arrow",
			"arrows": "iWayra_arrows",
			"control": "iWayra_control",
			"desc": "iWayra_desc",
			"row": "iWayra_row",
			"rowText": "iWayra_rowText",
			"stepper": "iWayra_stepper",
			"title": "iWayra_title",
			"unit": "iWayra_unit",
			"value": "iWayra_value"
		};
		...
		*/
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/styles/base.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/styles/design-platform.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/styles/scrollbar.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/styles/gradient-shadow-text.css.mjs
		...
		//#endregion
		//#region \0dsh-inline-css:/private/tmp/dsh-alpha/packages/client/ui-theme/src/styles/shiki.css.mjs
