window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$3 = ".Afuy2a_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Afuy2a_field+.Afuy2a_field{border-top:1px solid var(--dsw-alias-border-l2)}.Afuy2a_head{align-items:center;gap:8px;display:flex}.Afuy2a_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Afuy2a_badges{align-items:center;gap:8px;display:inline-flex}.Afuy2a_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Afuy2a_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Afuy2a_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Afuy2a_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Afuy2a_reset:disabled{cursor:default}.Afuy2a_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Afuy2a_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Afuy2a_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Afuy2a_inputInvalid{border-color:var(--dsw-alias-label-error);}.Afuy2a_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Afuy2a_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badge": "Afuy2a_badge",
			"badgeMuted": "Afuy2a_badgeMuted",
			"badges": "Afuy2a_badges",
			"field": "Afuy2a_field",
			"head": "Afuy2a_head",
			"hint": "Afuy2a_hint",
			"input": "Afuy2a_input",
			"inputInvalid": "Afuy2a_inputInvalid",
			"invalid": "Afuy2a_invalid",
			"label": "Afuy2a_label",
			"reset": "Afuy2a_reset"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$2 = ".LehhLW_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.LehhLW_card:hover{border-color:var(--dsw-alias-label-dimmed)}.LehhLW_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.LehhLW_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.LehhLW_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.LehhLW_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.LehhLW_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.LehhLW_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.LehhLW_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.LehhLW_chevronOpen{transform:rotate(180deg)}.LehhLW_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.LehhLW_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.LehhLW_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.LehhLW_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.LehhLW_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.LehhLW_discard,.LehhLW_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.LehhLW_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.LehhLW_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.LehhLW_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.LehhLW_discard:disabled,.LehhLW_save:disabled{opacity:.4;cursor:default}.LehhLW_discard:focus-visible,.LehhLW_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"body": "LehhLW_body",
			"card": "LehhLW_card",
			"cardOpen": "LehhLW_cardOpen",
			"chevron": "LehhLW_chevron",
			"chevronOpen": "LehhLW_chevronOpen",
			"description": "LehhLW_description",
			"discard": "LehhLW_discard",
			"failed": "LehhLW_failed",
			"footer": "LehhLW_footer",
			"headText": "LehhLW_headText",
			"header": "LehhLW_header",
			"name": "LehhLW_name",
			"pending": "LehhLW_pending",
			"readOnly": "LehhLW_readOnly",
			"save": "LehhLW_save"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css$1 = ".YspyUa_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.YspyUa_heading{margin:0;font-size:18px;font-weight:600}.YspyUa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.YspyUa_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.YspyUa_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.YspyUa_tab:hover,.YspyUa_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.YspyUa_tab[data-active=true]:after,.YspyUa_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.YspyUa_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.YspyUa_panel{min-width:0;padding-top:2px}.YspyUa_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.YspyUa_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "YspyUa_cards",
			"empty": "YspyUa_empty",
			"heading": "YspyUa_heading",
			"intro": "YspyUa_intro",
			"panel": "YspyUa_panel",
			"section": "YspyUa_section",
			"tab": "YspyUa_tab",
			"tabs": "YspyUa_tabs"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-settings-plugins/src/client/SubagentModelSelectionCard.module.css.mjs
		const css = ".dTGPsa_permission{gap:6px;padding:12px 0;display:grid}.dTGPsa_toggleRow{color:var(--dsw-alias-label-secondary);justify-content:space-between;align-items:flex-start;gap:16px;font-size:13px;line-height:1.5;display:flex}.dTGPsa_toggleLabel{flex:1;min-width:0}.dTGPsa_switch{box-sizing:border-box;background:var(--dsw-alias-border-l3);cursor:pointer;border:0;border-radius:10px;flex:none;width:36px;height:20px;padding:2px;position:relative}.dTGPsa_switchOn{background:var(--dsw-alias-brand-primary)}.dTGPsa_switch:disabled{cursor:default;opacity:.5}.dTGPsa_switch:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}.dTGPsa_thumb{background:var(--dsw-alias-label-primary-foreground);border-radius:50%;width:16px;height:16px;transition:transform .12s;display:block}.dTGPsa_switchOn .dTGPsa_thumb{transform:translate(16px)}.dTGPsa_selection{gap:10px;display:grid}.dTGPsa_hint,.dTGPsa_notice,.dTGPsa_invalid,.dTGPsa_conflict{margin:0;font-size:12px;line-height:1.5}.dTGPsa_hint,.dTGPsa_notice{color:var(--dsw-alias-label-tertiary)}.dTGPsa_invalid,.dTGPsa_conflict{color:var(--dsw-alias-label-error)}.dTGPsa_catalogError{color:var(--dsw-alias-label-error);justify-content:space-between;align-items:center;gap:12px;font-size:12px;display:flex}.dTGPsa_catalogError button{color:var(--dsw-alias-brand-primary);cursor:pointer;background:0 0;border:0;padding:0}.dTGPsa_models{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;gap:6px;min-width:0;max-height:280px;margin:0;padding:10px;display:grid;overflow:auto}.dTGPsa_models legend{color:var(--dsw-alias-label-secondary);padding:0 4px;font-size:12px}.dTGPsa_modelGroup{gap:6px;display:grid}.dTGPsa_modelGroup+.dTGPsa_modelGroup{border-top:1px solid var(--dsw-alias-border-l3);margin-top:4px;padding-top:10px}.dTGPsa_providerName{color:var(--dsw-alias-label-tertiary);padding:0 6px;font-size:11px;font-weight:500}.dTGPsa_model{cursor:pointer;border-radius:6px;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;min-width:0;padding:6px;display:grid}.dTGPsa_model:hover{background:var(--dsw-alias-bg-layer-4)}.dTGPsa_modelName,.dTGPsa_route{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.dTGPsa_modelName{color:var(--dsw-alias-label-primary);font-size:13px}.dTGPsa_route{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:11px}.dTGPsa_unavailable{color:var(--dsw-alias-label-tertiary);font-size:11px}";
		...
		var SubagentModelSelectionCard_module_css_default = {
			"catalogError": "dTGPsa_catalogError",
			"conflict": "dTGPsa_conflict",
			"hint": "dTGPsa_hint",
			"invalid": "dTGPsa_invalid",
			"model": "dTGPsa_model",
			"modelGroup": "dTGPsa_modelGroup",
			"modelName": "dTGPsa_modelName",
			"models": "dTGPsa_models",
			"notice": "dTGPsa_notice",
			"permission": "dTGPsa_permission",
			"providerName": "dTGPsa_providerName",
			"route": "dTGPsa_route",
			"selection": "dTGPsa_selection",
			"switch": "dTGPsa_switch",
			"switchOn": "dTGPsa_switchOn",
			"thumb": "dTGPsa_thumb",
			"toggleLabel": "dTGPsa_toggleLabel",
			"toggleRow": "dTGPsa_toggleRow",
			"unavailable": "dTGPsa_unavailable"
		};
		//#endregion
