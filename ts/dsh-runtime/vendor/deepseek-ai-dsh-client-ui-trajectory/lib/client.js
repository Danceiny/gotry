window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-trajectory/src/client/TrajectoryTable.module.css.mjs
		const css$3 = ".fIEnbG_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.fIEnbG_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:fIEnbG_trajectory-table/inline-size}.fIEnbG_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.fIEnbG_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.fIEnbG_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite fIEnbG_history-loading-spin}.fIEnbG_table tbody .fIEnbG_historyLoadRow td{height:30px;padding:0}.fIEnbG_table tbody .fIEnbG_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.fIEnbG_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.fIEnbG_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.fIEnbG_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.fIEnbG_historyLoadButton:disabled{cursor:default}.fIEnbG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.fIEnbG_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes fIEnbG_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.fIEnbG_historyLoadingSpinner{animation:none}}.fIEnbG_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.fIEnbG_eventColumn{width:122px}.fIEnbG_contentColumn{width:auto}.fIEnbG_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.fIEnbG_eventHeader{text-align:right!important;padding-right:4px!important}.fIEnbG_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.fIEnbG_table tbody .fIEnbG_virtualSpacer{pointer-events:none}.fIEnbG_table tbody .fIEnbG_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.fIEnbG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.fIEnbG_table tbody tr[data-timeline-focus=outside]{opacity:.24}.fIEnbG_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_table tbody tr[data-request-only=true]:hover{background:0 0}.fIEnbG_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.fIEnbG_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.fIEnbG_table tbody tr[data-request-only=true] .fIEnbG_turnRail{top:-15px;bottom:0}.fIEnbG_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.fIEnbG_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.fIEnbG_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.fIEnbG_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.fIEnbG_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.fIEnbG_requestBoundaryControl:hover:before,.fIEnbG_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.fIEnbG_requestBoundaryControlActive:before,.fIEnbG_requestBoundaryControlActive:hover:before,.fIEnbG_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.fIEnbG_requestBoundaryControl[data-request-status=error]:before,.fIEnbG_requestBoundaryControl[data-request-status=error]:hover:before,.fIEnbG_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.fIEnbG_requestBoundaryControl:hover:after,.fIEnbG_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.fIEnbG_requestBoundaryControl:focus-visible{outline:none}.fIEnbG_table tbody tr:has(.fIEnbG_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.fIEnbG_event{position:relative}.fIEnbG_turnRail,.fIEnbG_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.fIEnbG_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.fIEnbG_table tbody tr[data-turn-end=true] .fIEnbG_turnRail{bottom:0}.fIEnbG_selectionRail{z-index:5;width:3px;top:0;bottom:0}.fIEnbG_table tbody tr[data-error=true] .fIEnbG_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.fIEnbG_table tbody tr[data-error=true] .fIEnbG_selectionRail{background:var(--dsw-alias-state-error-primary)}.fIEnbG_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.fIEnbG_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.fIEnbG_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.fIEnbG_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.fIEnbG_turnLabelFull,.fIEnbG_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.fIEnbG_turnLabelCompact{opacity:0;max-width:0}.fIEnbG_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.fIEnbG_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.fIEnbG_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.fIEnbG_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.fIEnbG_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.fIEnbG_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.fIEnbG_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.fIEnbG_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.fIEnbG_table .fIEnbG_kindSlot .fIEnbG_message{justify-content:center;width:100%}@container fIEnbG_trajectory-table (width<=620px){.fIEnbG_eventColumn{width:50px}.fIEnbG_event{padding-left:28px!important;padding-right:3px!important}.fIEnbG_requestBoundaryControl{--request-boundary-base-left:6px}.fIEnbG_kindSlot{width:19px}.fIEnbG_kindTag,.fIEnbG_table .fIEnbG_kindSlot .fIEnbG_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.fIEnbG_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.fIEnbG_kindTagLabel,.fIEnbG_turnLabelFull{opacity:0;max-width:0}.fIEnbG_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.fIEnbG_eventColumn,.fIEnbG_event,.fIEnbG_requestBoundaryControl,.fIEnbG_kindSlot,.fIEnbG_kindTag,.fIEnbG_kindTagIcon,.fIEnbG_kindTagLabel,.fIEnbG_turnLabelFull,.fIEnbG_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.fIEnbG_eventColumn,.fIEnbG_kindSlot{transition-property:width}.fIEnbG_event{transition-property:padding-right,padding-left}.fIEnbG_requestBoundaryControl{transition-property:left}.fIEnbG_kindTag{transition-property:padding-right,padding-left}.fIEnbG_kindTagIcon{transition-property:width,opacity,transform}.fIEnbG_kindTagLabel,.fIEnbG_turnLabelFull,.fIEnbG_turnLabelCompact{transition-property:max-width,opacity}}.fIEnbG_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.fIEnbG_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.fIEnbG_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.fIEnbG_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.fIEnbG_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.fIEnbG_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.fIEnbG_promptDiffSection{min-width:0}.fIEnbG_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.fIEnbG_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.fIEnbG_promptDiff span{min-width:max-content;padding:0 6px;display:block}.fIEnbG_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.fIEnbG_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.fIEnbG_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.fIEnbG_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.fIEnbG_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.fIEnbG_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.fIEnbG_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.fIEnbG_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.fIEnbG_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.fIEnbG_table tbody tr[data-collapsed-summary=turn] td,.fIEnbG_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.fIEnbG_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.fIEnbG_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.fIEnbG_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.fIEnbG_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.fIEnbG_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.fIEnbG_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.fIEnbG_resultRequest,.fIEnbG_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.fIEnbG_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.fIEnbG_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.fIEnbG_table tbody tr[data-kind=tool] .fIEnbG_contentText,.fIEnbG_table tbody tr[data-kind=subtool] .fIEnbG_contentText,.fIEnbG_table tbody tr[data-kind=tool] .fIEnbG_resultPreview,.fIEnbG_table tbody tr[data-kind=subtool] .fIEnbG_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.fIEnbG_table tbody tr[data-kind=subtool] .fIEnbG_content{padding-left:26px}.fIEnbG_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.fIEnbG_noOutputText{color:var(--dsw-alias-label-caption)}.fIEnbG_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.fIEnbG_error,.fIEnbG_overview dd.fIEnbG_error,.fIEnbG_details .fIEnbG_errorPayload{color:var(--dsw-alias-state-error-primary)}.fIEnbG_details .fIEnbG_errorPayload .fIEnbG_resultBlockText{color:inherit}.fIEnbG_details .fIEnbG_jsonPayload.fIEnbG_errorPayload,.fIEnbG_details .fIEnbG_jsonPreview.fIEnbG_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.fIEnbG_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.fIEnbG_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.fIEnbG_detailsResizeHandle:focus-visible{outline:none}.fIEnbG_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.fIEnbG_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.fIEnbG_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.fIEnbG_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.fIEnbG_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.fIEnbG_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.fIEnbG_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.fIEnbG_detailTabs::-webkit-scrollbar{display:none}.fIEnbG_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.fIEnbG_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_detailTabActive{color:var(--dsw-alias-state-business-primary)}.fIEnbG_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.fIEnbG_close:focus-visible,.fIEnbG_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.fIEnbG_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.fIEnbG_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.fIEnbG_detailBodySummary>.fIEnbG_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.fIEnbG_detailBodySummary>.fIEnbG_compactedSummary{flex:1;min-height:0;overflow:auto}.fIEnbG_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.fIEnbG_summaryScrollRegion:hover,.fIEnbG_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.fIEnbG_compactedSummary .fIEnbG_markdownPayload{padding-right:18px}.fIEnbG_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.fIEnbG_overviewParentLinks{gap:14px;display:flex}.fIEnbG_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.fIEnbG_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.fIEnbG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.fIEnbG_overviewHierarchyNavLink:hover .fIEnbG_overviewHierarchyJumpIconTight,.fIEnbG_overviewHierarchyNavLink:focus-visible .fIEnbG_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.fIEnbG_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.fIEnbG_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.fIEnbG_overview>.fIEnbG_requestTokenDetail dt{padding-left:12px}.fIEnbG_usagePanel{padding:4px 0 10px}.fIEnbG_usageGroup+.fIEnbG_usageGroup{margin-top:8px}.fIEnbG_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.fIEnbG_usageGroup .fIEnbG_overview{padding:0}.fIEnbG_overview dt{color:var(--dsw-alias-label-tertiary)}.fIEnbG_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.fIEnbG_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.fIEnbG_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.fIEnbG_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.fIEnbG_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.fIEnbG_overviewSection+.fIEnbG_overviewSection{padding-top:8px}.fIEnbG_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.fIEnbG_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.fIEnbG_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.fIEnbG_overviewTitle:hover .fIEnbG_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.fIEnbG_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.fIEnbG_overviewTitle:focus-visible .fIEnbG_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.fIEnbG_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.fIEnbG_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.fIEnbG_overviewPreview .fIEnbG_jsonPreview>:first-child,.fIEnbG_overviewPreview .fIEnbG_schemaTree>:first-child{padding-bottom:0}.fIEnbG_overviewPreview .fIEnbG_schemaTree{margin-bottom:0}.fIEnbG_overviewPreview .fIEnbG_overview{padding:2px 0 0}.fIEnbG_overviewPreview .fIEnbG_overview>div{min-height:22px}.fIEnbG_markdownPreview,.fIEnbG_markdownPayload{color:var(--dsw-alias-label-primary)}.fIEnbG_markdownPreview>div,.fIEnbG_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.fIEnbG_markdownPreview>div h1,.fIEnbG_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.fIEnbG_markdownPreview>div h2,.fIEnbG_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.fIEnbG_markdownPreview>div :where(h3,h4,h5,h6),.fIEnbG_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.fIEnbG_markdownPreview>div :not(pre)>code,.fIEnbG_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.fIEnbG_markdownPreview>div table,.fIEnbG_markdownPayload>div table{font:var(--dsw-font-xs-13)}.fIEnbG_markdownPreview>div>:first-child{margin-top:0}.fIEnbG_markdownPreview>div>:last-child{margin-bottom:0}.fIEnbG_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.fIEnbG_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.fIEnbG_markdownPreview>div :where(p,ul,ol){margin:8px 0}.fIEnbG_markdownPreview>div li:not(:first-child){margin-top:3px}.fIEnbG_markdownPreview>div blockquote{margin-top:8px}.fIEnbG_markdownPreview>div hr{margin:14px 0}.fIEnbG_markdownPreview>div>.md-code-block{margin:10px 0}.fIEnbG_assistantContent .fIEnbG_markdownPayload,.fIEnbG_assistantContent .fIEnbG_payload{min-height:0}.fIEnbG_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.fIEnbG_thinkingQuoteOnlyPreview{margin-bottom:8px}.fIEnbG_detailBody>.fIEnbG_assistantContentRendered .fIEnbG_thinkingQuote{margin-top:14px}.fIEnbG_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.fIEnbG_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.fIEnbG_thinkingToggle[aria-expanded=true] .fIEnbG_thinkingChevron{transform:rotate(90deg)}.fIEnbG_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.fIEnbG_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.fIEnbG_thinkingQuote .fIEnbG_markdownPreview,.fIEnbG_thinkingQuote .fIEnbG_markdownPayload,.fIEnbG_thinkingQuote .fIEnbG_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.fIEnbG_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.fIEnbG_markdownPreview{padding:6px 14px 8px}.fIEnbG_markdownPayload{min-height:100%;padding:14px}.fIEnbG_jsonPayload{min-height:100%}.fIEnbG_jsonPreview{min-height:0}.fIEnbG_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.fIEnbG_schemaPreview{min-height:0}.fIEnbG_schemaIntro{padding:12px 14px 6px}.fIEnbG_schemaPreview .fIEnbG_schemaIntro{padding-top:6px}.fIEnbG_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.fIEnbG_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.fIEnbG_schemaParameters{min-width:0}.fIEnbG_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.fIEnbG_schemaTree{margin:0 6px 8px 0}.fIEnbG_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.fIEnbG_payloadPreview{min-height:0;padding:6px 14px 8px}.fIEnbG_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.fIEnbG_sourceBlock+.fIEnbG_sourceBlock{margin-top:14px}.fIEnbG_sourceBlockHeader,.fIEnbG_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.fIEnbG_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.fIEnbG_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.fIEnbG_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.fIEnbG_sourceBlockJumpTarget:hover .fIEnbG_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.fIEnbG_sourceBlockJumpTarget:focus-visible{outline:none}.fIEnbG_sourceBlockJumpTarget:focus-visible .fIEnbG_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.fIEnbG_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.fIEnbG_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.fIEnbG_messageImagesPreview{gap:6px;margin:6px 14px 8px}.fIEnbG_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.fIEnbG_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.fIEnbG_assistantToolCalls li{min-width:0}.fIEnbG_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.fIEnbG_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.fIEnbG_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.fIEnbG_assistantToolCallButton:hover .fIEnbG_assistantToolCallIcon,.fIEnbG_assistantToolCallButton:focus-visible .fIEnbG_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.fIEnbG_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.fIEnbG_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.fIEnbG_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.fIEnbG_systemPrompt{box-sizing:border-box}.fIEnbG_toolCatalog{min-height:100%;padding:8px 0 16px}.fIEnbG_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.fIEnbG_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.fIEnbG_toolCatalogSummary::-webkit-details-marker{display:none}.fIEnbG_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.fIEnbG_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.fIEnbG_toolCatalogChevron,.fIEnbG_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.fIEnbG_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.fIEnbG_toolCatalogItem[open] .fIEnbG_toolCatalogChevron{transform:rotate(90deg)}.fIEnbG_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.fIEnbG_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.fIEnbG_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.fIEnbG_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.fIEnbG_toolCatalogTree{margin-left:-14px;margin-right:6px}.fIEnbG_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.fIEnbG_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.fIEnbG_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.fIEnbG_overviewPreview .fIEnbG_noPayload{padding:6px 14px 8px}.fIEnbG_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.fIEnbG_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"arrow": "fIEnbG_arrow",
			"assistantContent": "fIEnbG_assistantContent",
			"assistantContentRendered": "fIEnbG_assistantContentRendered",
			"assistantOutput": "fIEnbG_assistantOutput",
			"assistantToolCallArgs": "fIEnbG_assistantToolCallArgs",
			"assistantToolCallButton": "fIEnbG_assistantToolCallButton",
			"assistantToolCallIcon": "fIEnbG_assistantToolCallIcon",
			"assistantToolCallName": "fIEnbG_assistantToolCallName",
			"assistantToolCallText": "fIEnbG_assistantToolCallText",
			"assistantToolCalls": "fIEnbG_assistantToolCalls",
			"assistantToolCallsPreview": "fIEnbG_assistantToolCallsPreview",
			"assistantVioletBright": "fIEnbG_assistantVioletBright",
			"close": "fIEnbG_close",
			"collapsedTurnContent": "fIEnbG_collapsedTurnContent",
			"collapsedTurnEllipsis": "fIEnbG_collapsedTurnEllipsis",
			"collapsedTurnText": "fIEnbG_collapsedTurnText",
			"compacted": "fIEnbG_compacted",
			"compactedSummary": "fIEnbG_compactedSummary",
			"content": "fIEnbG_content",
			"contentColumn": "fIEnbG_contentColumn",
			"contentText": "fIEnbG_contentText",
			"contextGreen": "fIEnbG_contextGreen",
			"detailBody": "fIEnbG_detailBody",
			"detailBodySummary": "fIEnbG_detailBodySummary",
			"detailTab": "fIEnbG_detailTab",
			"detailTabActive": "fIEnbG_detailTabActive",
			"detailTabs": "fIEnbG_detailTabs",
			"details": "fIEnbG_details",
			"detailsHeader": "fIEnbG_detailsHeader",
			"detailsLocation": "fIEnbG_detailsLocation",
			"detailsResizeHandle": "fIEnbG_detailsResizeHandle",
			"detailsTitle": "fIEnbG_detailsTitle",
			"error": "fIEnbG_error",
			"errorPayload": "fIEnbG_errorPayload",
			"event": "fIEnbG_event",
			"eventColumn": "fIEnbG_eventColumn",
			"eventHeader": "fIEnbG_eventHeader",
			"eventInner": "fIEnbG_eventInner",
			"history-loading-spin": "fIEnbG_history-loading-spin",
			"historyLoadButton": "fIEnbG_historyLoadButton",
			"historyLoadRow": "fIEnbG_historyLoadRow",
			"historyLoading": "fIEnbG_historyLoading",
			"historyLoadingBar": "fIEnbG_historyLoadingBar",
			"historyLoadingSpinner": "fIEnbG_historyLoadingSpinner",
			"inlineResult": "fIEnbG_inlineResult",
			"inlineResultText": "fIEnbG_inlineResultText",
			"jsonPayload": "fIEnbG_jsonPayload",
			"jsonPreview": "fIEnbG_jsonPreview",
			"kindSlot": "fIEnbG_kindSlot",
			"kindTag": "fIEnbG_kindTag",
			"kindTagIcon": "fIEnbG_kindTagIcon",
			"kindTagLabel": "fIEnbG_kindTagLabel",
			"markdownPayload": "fIEnbG_markdownPayload",
			"markdownPreview": "fIEnbG_markdownPreview",
			"message": "fIEnbG_message",
			"messageImages": "fIEnbG_messageImages",
			"messageImagesPreview": "fIEnbG_messageImagesPreview",
			"noOutputText": "fIEnbG_noOutputText",
			"noPayload": "fIEnbG_noPayload",
			"overview": "fIEnbG_overview",
			"overviewHeading": "fIEnbG_overviewHeading",
			"overviewHierarchyJumpIconTight": "fIEnbG_overviewHierarchyJumpIconTight",
			"overviewHierarchyNavLink": "fIEnbG_overviewHierarchyNavLink",
			"overviewParentLinks": "fIEnbG_overviewParentLinks",
			"overviewPreview": "fIEnbG_overviewPreview",
			"overviewSection": "fIEnbG_overviewSection",
			"overviewSections": "fIEnbG_overviewSections",
			"overviewTitle": "fIEnbG_overviewTitle",
			"overviewTitleIcon": "fIEnbG_overviewTitleIcon",
			"payload": "fIEnbG_payload",
			"payloadPreview": "fIEnbG_payloadPreview",
			"promptDiff": "fIEnbG_promptDiff",
			"promptDiffLineadded": "fIEnbG_promptDiffLineadded",
			"promptDiffLinecontext": "fIEnbG_promptDiffLinecontext",
			"promptDiffLinemeta": "fIEnbG_promptDiffLinemeta",
			"promptDiffLineremoved": "fIEnbG_promptDiffLineremoved",
			"promptDiffSection": "fIEnbG_promptDiffSection",
			"promptDiffSections": "fIEnbG_promptDiffSections",
			"promptDiffTitle": "fIEnbG_promptDiffTitle",
			"requestBoundaryControl": "fIEnbG_requestBoundaryControl",
			"requestBoundaryControlActive": "fIEnbG_requestBoundaryControlActive",
			"requestDetailsDot": "fIEnbG_requestDetailsDot",
			"requestDetailsName": "fIEnbG_requestDetailsName",
			"requestTokenDetail": "fIEnbG_requestTokenDetail",
			"resultBlockText": "fIEnbG_resultBlockText",
			"resultBlocks": "fIEnbG_resultBlocks",
			"resultBlocksPreview": "fIEnbG_resultBlocksPreview",
			"resultPreview": "fIEnbG_resultPreview",
			"resultRequest": "fIEnbG_resultRequest",
			"schema": "fIEnbG_schema",
			"schemaDescription": "fIEnbG_schemaDescription",
			"schemaIntro": "fIEnbG_schemaIntro",
			"schemaName": "fIEnbG_schemaName",
			"schemaParameters": "fIEnbG_schemaParameters",
			"schemaParametersTitle": "fIEnbG_schemaParametersTitle",
			"schemaPreview": "fIEnbG_schemaPreview",
			"schemaTree": "fIEnbG_schemaTree",
			"selectionRail": "fIEnbG_selectionRail",
			"sourceBlock": "fIEnbG_sourceBlock",
			"sourceBlockContent": "fIEnbG_sourceBlockContent",
			"sourceBlockHeader": "fIEnbG_sourceBlockHeader",
			"sourceBlockJumpIcon": "fIEnbG_sourceBlockJumpIcon",
			"sourceBlockJumpTarget": "fIEnbG_sourceBlockJumpTarget",
			"sourceBlockLabel": "fIEnbG_sourceBlockLabel",
			"sourceBlocks": "fIEnbG_sourceBlocks",
			"split": "fIEnbG_split",
			"subtoolAmber": "fIEnbG_subtoolAmber",
			"summaryScrollRegion": "fIEnbG_summaryScrollRegion",
			"systemNeutral": "fIEnbG_systemNeutral",
			"systemPrompt": "fIEnbG_systemPrompt",
			"table": "fIEnbG_table",
			"tablePane": "fIEnbG_tablePane",
			"thinkingChevron": "fIEnbG_thinkingChevron",
			"thinkingQuote": "fIEnbG_thinkingQuote",
			"thinkingQuoteOnlyPreview": "fIEnbG_thinkingQuoteOnlyPreview",
			"thinkingToggle": "fIEnbG_thinkingToggle",
			"timestampToggle": "fIEnbG_timestampToggle",
			"toolAmber": "fIEnbG_toolAmber",
			"toolCallNameTypeface": "fIEnbG_toolCallNameTypeface",
			"toolCallOnly": "fIEnbG_toolCallOnly",
			"toolCallPayload": "fIEnbG_toolCallPayload",
			"toolCatalog": "fIEnbG_toolCatalog",
			"toolCatalogChevron": "fIEnbG_toolCatalogChevron",
			"toolCatalogDefinition": "fIEnbG_toolCatalogDefinition",
			"toolCatalogDescription": "fIEnbG_toolCatalogDescription",
			"toolCatalogFullDescription": "fIEnbG_toolCatalogFullDescription",
			"toolCatalogIcon": "fIEnbG_toolCatalogIcon",
			"toolCatalogItem": "fIEnbG_toolCatalogItem",
			"toolCatalogName": "fIEnbG_toolCatalogName",
			"toolCatalogSummary": "fIEnbG_toolCatalogSummary",
			"toolCatalogTree": "fIEnbG_toolCatalogTree",
			"trajectory-table": "fIEnbG_trajectory-table",
			"turnLabel": "fIEnbG_turnLabel",
			"turnLabelActive": "fIEnbG_turnLabelActive",
			"turnLabelCompact": "fIEnbG_turnLabelCompact",
			"turnLabelFull": "fIEnbG_turnLabelFull",
			"turnRail": "fIEnbG_turnRail",
			"usageGroup": "fIEnbG_usageGroup",
			"usageHeading": "fIEnbG_usageHeading",
			"usagePanel": "fIEnbG_usagePanel",
			"user": "fIEnbG_user",
			"virtualSpacer": "fIEnbG_virtualSpacer",
			"visuallyHidden": "fIEnbG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-trajectory/src/client/TrajectoryToolbar.module.css.mjs
		const css$2 = ".VjBnJq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.VjBnJq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.VjBnJq_actions{flex:none;align-items:center;gap:2px;display:flex}.VjBnJq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.VjBnJq_toggle:hover,.VjBnJq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.VjBnJq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.VjBnJq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.VjBnJq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.VjBnJq_control[hidden]{display:none}.VjBnJq_control:hover:not(:disabled),.VjBnJq_control[aria-checked=true],.VjBnJq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.VjBnJq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.VjBnJq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.VjBnJq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.VjBnJq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.VjBnJq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.VjBnJq_controlTrack[data-on=true] .VjBnJq_controlThumb{transform:translate(10px)}.VjBnJq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.VjBnJq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.VjBnJq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.VjBnJq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.VjBnJq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.VjBnJq_search:hover{border-color:var(--dsw-alias-label-caption)}.VjBnJq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.VjBnJq_searchIcon{flex:none}.VjBnJq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.VjBnJq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.VjBnJq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"action": "VjBnJq_action",
			"actionIcon": "VjBnJq_actionIcon",
			"actions": "VjBnJq_actions",
			"control": "VjBnJq_control",
			"controlThumb": "VjBnJq_controlThumb",
			"controlTrack": "VjBnJq_controlTrack",
			"inner": "VjBnJq_inner",
			"root": "VjBnJq_root",
			"search": "VjBnJq_search",
			"searchIcon": "VjBnJq_searchIcon",
			"searchInput": "VjBnJq_searchInput",
			"toggle": "VjBnJq_toggle",
			"toggleIcon": "VjBnJq_toggleIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-trajectory/src/client/TrajectoryTimeline.module.css.mjs
		const css$1 = ".bWlYcG_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.bWlYcG_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.bWlYcG_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.bWlYcG_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.bWlYcG_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.bWlYcG_labels span:first-child{top:7px}.bWlYcG_labels span:nth-child(2){top:21px}.bWlYcG_labels span:nth-child(3){top:35px}.bWlYcG_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.bWlYcG_track[data-panning=true]{cursor:grabbing}.bWlYcG_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.bWlYcG_earlierHistory:hover{opacity:1}.bWlYcG_earlierHistory[aria-disabled=true]{cursor:default}.bWlYcG_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.bWlYcG_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.bWlYcG_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.bWlYcG_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.bWlYcG_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.bWlYcG_lanes[data-animate-viewport=true],.bWlYcG_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.bWlYcG_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.bWlYcG_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.bWlYcG_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.bWlYcG_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.bWlYcG_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.bWlYcG_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.bWlYcG_span[data-timeline-span=tool],.bWlYcG_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.bWlYcG_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.bWlYcG_span[data-equal-duration=true]{width:8px;min-width:8px}.bWlYcG_span[data-selected=false]{opacity:.2}.bWlYcG_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.bWlYcG_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.bWlYcG_span[data-search-match=false]{opacity:.14}.bWlYcG_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.bWlYcG_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.bWlYcG_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.bWlYcG_selectionEdges:before,.bWlYcG_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.bWlYcG_selectionEdges:before{left:0}.bWlYcG_selectionEdges:after{right:0}.bWlYcG_selectionEdges[data-dragging=true]:before,.bWlYcG_selectionEdges[data-dragging=true]:after{width:2px}.bWlYcG_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"earlierHistory": "bWlYcG_earlierHistory",
			"empty": "bWlYcG_empty",
			"hoverLine": "bWlYcG_hoverLine",
			"labels": "bWlYcG_labels",
			"lanes": "bWlYcG_lanes",
			"plot": "bWlYcG_plot",
			"root": "bWlYcG_root",
			"selection": "bWlYcG_selection",
			"selectionEdges": "bWlYcG_selectionEdges",
			"span": "bWlYcG_span",
			"track": "bWlYcG_track",
			"turnBoundaries": "bWlYcG_turnBoundaries",
			"turnBoundary": "bWlYcG_turnBoundary"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-trajectory/src/client/views.module.css.mjs
		const css = ".AZHcnq_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.AZHcnq_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
