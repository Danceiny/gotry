window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-input-trigger/src/client/MenuView.module.css.mjs
		const css = ".H6EyGG_menu{z-index:100;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);max-height:320px;box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 4px);left:0;right:0;overflow:hidden}.H6EyGG_viewport{flex-direction:column;min-height:0;display:flex;overflow-y:auto}.H6EyGG_item{cursor:pointer;width:100%;min-height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:8px 10px;font-size:14px;line-height:22px;display:flex}.H6EyGG_item.H6EyGG_active{background:var(--dsw-alias-interactive-bg-hover)}.H6EyGG_sectionTitle{min-height:26px;color:var(--dsw-alias-label-tertiary);flex:none;padding:6px 10px 2px;font-size:12px;font-weight:500;line-height:18px}.H6EyGG_sectionTitle:not(:first-child){margin-top:4px}.H6EyGG_itemIcon{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.H6EyGG_itemName{text-overflow:ellipsis;white-space:nowrap;flex:none;max-width:40%;overflow:hidden}.H6EyGG_itemDescription{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:1;overflow:hidden}.H6EyGG_trailing{flex:none;align-items:center;gap:4px;margin-left:auto;display:inline-flex}.H6EyGG_drillHintText{color:var(--dsw-alias-label-caption);white-space:nowrap;font-size:11px;line-height:18px;display:none}.H6EyGG_drillHint{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-caption);border-radius:4px;padding:0 5px;font-family:inherit;font-size:11px;line-height:18px;display:none}.H6EyGG_item.H6EyGG_active .H6EyGG_drillHintText,.H6EyGG_item.H6EyGG_active .H6EyGG_drillHint{display:inline-flex}.H6EyGG_drill{width:20px;height:20px;color:var(--dsw-alias-label-caption);border-radius:4px;flex:none;place-items:center;display:inline-grid}.H6EyGG_drill:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.H6EyGG_groupTitle{color:var(--dsw-alias-label-tertiary);padding:8px 10px;font-size:12px;line-height:16px}.H6EyGG_skeletonRow{box-sizing:border-box;align-items:center;min-height:40px;padding:8px 10px;display:flex}.H6EyGG_skeletonBar{background:var(--dsw-alias-bg-skeleton);border-radius:4px;height:20px;animation:2s cubic-bezier(.36,0,.64,1) infinite H6EyGG_dsh-menu-skeleton}@keyframes H6EyGG_dsh-menu-skeleton{0%{opacity:1}40%{opacity:.6}80%,to{opacity:1}}.H6EyGG_crumbs{border-bottom:1px solid var(--dsw-alias-border-inverted);flex-wrap:wrap;flex:none;align-items:center;gap:2px;margin-bottom:2px;padding:4px 6px 6px;display:flex}.H6EyGG_crumb{max-width:40%;color:var(--dsw-alias-label-tertiary);cursor:pointer;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:6px;flex:0 auto;padding:2px 6px;font-family:inherit;font-size:12px;line-height:18px;overflow:hidden}.H6EyGG_crumb:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.H6EyGG_crumbCurrent,.H6EyGG_crumbCurrent:hover{color:var(--dsw-alias-label-primary);cursor:default;background:0 0}.H6EyGG_crumbSeparator{color:var(--dsw-alias-label-caption);flex:none;display:inline-flex}";
		...
		var MenuView_module_css_default = {
			"active": "H6EyGG_active",
			"crumb": "H6EyGG_crumb",
			"crumbCurrent": "H6EyGG_crumbCurrent",
			"crumbSeparator": "H6EyGG_crumbSeparator",
			"crumbs": "H6EyGG_crumbs",
			"drill": "H6EyGG_drill",
			"drillHint": "H6EyGG_drillHint",
			"drillHintText": "H6EyGG_drillHintText",
			"dsh-menu-skeleton": "H6EyGG_dsh-menu-skeleton",
			"groupTitle": "H6EyGG_groupTitle",
			"item": "H6EyGG_item",
			"itemDescription": "H6EyGG_itemDescription",
			"itemIcon": "H6EyGG_itemIcon",
			"itemName": "H6EyGG_itemName",
			"menu": "H6EyGG_menu",
			"sectionTitle": "H6EyGG_sectionTitle",
			"skeletonBar": "H6EyGG_skeletonBar",
			"skeletonRow": "H6EyGG_skeletonRow",
			"trailing": "H6EyGG_trailing",
			"viewport": "H6EyGG_viewport"
		};
		//#endregion
