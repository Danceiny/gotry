window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-skill/src/client/SkillRow.module.css.mjs
		const css = ".-\\31 wFUq_card{flex-direction:column;display:flex}.-\\31 wFUq_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.-\\31 wFUq_row[data-expandable]{cursor:pointer}.-\\31 wFUq_card[data-state=running] .-\\31 wFUq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite -\\31 wFUq_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes -\\31 wFUq_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.-\\31 wFUq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.-\\31 wFUq_chevron{color:var(--dsw-alias-label-secondary)}.-\\31 wFUq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.-\\31 wFUq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.-\\31 wFUq_row:hover .-\\31 wFUq_iconIdle{opacity:0}.-\\31 wFUq_row:hover .-\\31 wFUq_chevronHover{opacity:1}.-\\31 wFUq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.-\\31 wFUq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.-\\31 wFUq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.-\\31 wFUq_errorSummary{color:var(--dsw-alias-state-error-primary)}.-\\31 wFUq_bodyWrap{flex-direction:column;display:flex}.-\\31 wFUq_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.-\\31 wFUq_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.-\\31 wFUq_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.-\\31 wFUq_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.-\\31 wFUq_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.-\\31 wFUq_instructions::-webkit-scrollbar-track{margin:6px 0}.-\\31 wFUq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.-\\31 wFUq_card:hover .-\\31 wFUq_inspectButton,.-\\31 wFUq_inspectButton:focus-visible{opacity:1}.-\\31 wFUq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.-\\31 wFUq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.-\\31 wFUq_card[data-state=running] .-\\31 wFUq_row:after{animation:none;display:none}.-\\31 wFUq_iconIdle,.-\\31 wFUq_chevronHover,.-\\31 wFUq_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"bodyWrap": "-1wFUq_bodyWrap",
			"card": "-1wFUq_card",
			"chevron": "-1wFUq_chevron",
			"chevronHover": "-1wFUq_chevronHover",
			"dsh-skill-row-sweep": "-1wFUq_dsh-skill-row-sweep",
			"errorSummary": "-1wFUq_errorSummary",
			"iconIdle": "-1wFUq_iconIdle",
			"inspectButton": "-1wFUq_inspectButton",
			"instructions": "-1wFUq_instructions",
			"instructionsCard": "-1wFUq_instructionsCard",
			"instructionsHeader": "-1wFUq_instructionsHeader",
			"leading": "-1wFUq_leading",
			"row": "-1wFUq_row",
			"separator": "-1wFUq_separator",
			"summary": "-1wFUq_summary",
			"title": "-1wFUq_title",
			"visuallyHidden": "-1wFUq_visuallyHidden"
		};
		//#endregion
