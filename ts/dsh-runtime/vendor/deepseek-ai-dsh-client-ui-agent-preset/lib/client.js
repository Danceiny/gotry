window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = "._8uxJPG_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}._8uxJPG_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".fu8Jna_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.fu8Jna_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.fu8Jna_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.fu8Jna_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.fu8Jna_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.fu8Jna_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.fu8Jna_selector:disabled{cursor:default}.fu8Jna_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"chevron": "fu8Jna_chevron",
			"desc": "fu8Jna_desc",
			"row": "fu8Jna_row",
			"rowText": "fu8Jna_rowText",
			"selector": "fu8Jna_selector",
			"title": "fu8Jna_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = "._5TXt0q_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}._5TXt0q_seat:not(:disabled):hover,._5TXt0q_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}._5TXt0q_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}._5TXt0q_seatIcon{color:var(--dsw-alias-label-primary);flex:none}._5TXt0q_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both _5TXt0q_seat-icon-in}@keyframes _5TXt0q_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}._5TXt0q_introText{white-space:pre;display:inline-block}._5TXt0q_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards _5TXt0q_seat-char-in;display:inline-block}@keyframes _5TXt0q_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){._5TXt0q_introIcon,._5TXt0q_introChar{opacity:1;animation:none}}._5TXt0q_chevron{color:var(--dsw-alias-label-caption);flex:none}._5TXt0q_item{flex-direction:column;gap:2px;max-width:280px;display:flex}._5TXt0q_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}._5TXt0q_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"chevron": "_5TXt0q_chevron",
			"introChar": "_5TXt0q_introChar",
			"introIcon": "_5TXt0q_introIcon",
			"introText": "_5TXt0q_introText",
			"item": "_5TXt0q_item",
			"itemDesc": "_5TXt0q_itemDesc",
			"itemName": "_5TXt0q_itemName",
			"seat": "_5TXt0q_seat",
			"seat-char-in": "_5TXt0q_seat-char-in",
			"seat-icon-in": "_5TXt0q_seat-icon-in",
			"seatIcon": "_5TXt0q_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".fJfbQa_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.fJfbQa_title{margin:0;font-size:18px;font-weight:600}.fJfbQa_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.fJfbQa_group{flex-direction:column;gap:10px;display:flex}.fJfbQa_group+.fJfbQa_group{margin-top:20px}.fJfbQa_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.fJfbQa_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.fJfbQa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.fJfbQa_card:hover:not(.fJfbQa_cardActive){border-color:var(--dsw-alias-label-dimmed)}.fJfbQa_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.fJfbQa_cardBroken,.fJfbQa_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.fJfbQa_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.fJfbQa_brokenTip{z-index:1;background:var(--dsw-alias-label-primary);width:max-content;max-width:100%;color:var(--dsw-alias-bg-layer-3);text-align:left;white-space:pre-line;overflow-wrap:anywhere;opacity:0;pointer-events:none;border-radius:6px;padding:6px 8px;font-size:11px;font-weight:400;line-height:1.5;transition:opacity .12s;position:absolute;top:calc(100% + 6px);left:0}.fJfbQa_brokenBadge:hover .fJfbQa_brokenTip,.fJfbQa_cardMain:focus-visible .fJfbQa_brokenTip{opacity:1}.fJfbQa_cardMain[aria-disabled=true]{cursor:default}.fJfbQa_cardBrokenReason{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.fJfbQa_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.fJfbQa_cardMain:disabled{cursor:default}.fJfbQa_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.fJfbQa_cardHead{align-items:center;gap:8px;display:flex;position:relative}.fJfbQa_cardName{font-size:15px;font-weight:600;line-height:1.4}.fJfbQa_badge,.fJfbQa_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.fJfbQa_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.fJfbQa_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.fJfbQa_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.fJfbQa_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.fJfbQa_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.fJfbQa_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.fJfbQa_iconButton:disabled{opacity:.4;cursor:default}.fJfbQa_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.fJfbQa_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.fJfbQa_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.fJfbQa_iconButton:hover:after,.fJfbQa_iconButton:focus-visible:after{opacity:1}.fJfbQa_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.fJfbQa_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.fJfbQa_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.fJfbQa_revealedPathLabel{white-space:nowrap}.fJfbQa_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.fJfbQa_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.fJfbQa_secondaryButton:disabled{opacity:.5;cursor:default}.fJfbQa_field{flex-direction:column;gap:6px;display:flex}.fJfbQa_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.fJfbQa_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.fJfbQa_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.fJfbQa_input::placeholder{color:var(--dsw-alias-label-dimmed)}.fJfbQa_dialog{width:min(560px,100%)}.fJfbQa_dialogFields{flex-direction:column;gap:12px;display:flex}.fJfbQa_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.fJfbQa_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.fJfbQa_deleteDialog{width:min(480px,100%)}.fJfbQa_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.fJfbQa_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.fJfbQa_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.fJfbQa_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.fJfbQa_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"badge": "fJfbQa_badge",
			"brokenBadge": "fJfbQa_brokenBadge",
			"brokenTip": "fJfbQa_brokenTip",
			"card": "fJfbQa_card",
			"cardActive": "fJfbQa_cardActive",
			"cardBroken": "fJfbQa_cardBroken",
			"cardBrokenReason": "fJfbQa_cardBrokenReason",
			"cardDesc": "fJfbQa_cardDesc",
			"cardFoot": "fJfbQa_cardFoot",
			"cardHead": "fJfbQa_cardHead",
			"cardId": "fJfbQa_cardId",
			"cardMain": "fJfbQa_cardMain",
			"cardName": "fJfbQa_cardName",
			"cards": "fJfbQa_cards",
			"creatorButton": "fJfbQa_creatorButton",
			"deleteConfirm": "fJfbQa_deleteConfirm",
			"deleteDialog": "fJfbQa_deleteDialog",
			"dialog": "fJfbQa_dialog",
			"dialogFields": "fJfbQa_dialogFields",
			"error": "fJfbQa_error",
			"field": "fJfbQa_field",
			"fieldLabel": "fJfbQa_fieldLabel",
			"group": "fJfbQa_group",
			"groupHead": "fJfbQa_groupHead",
			"iconButton": "fJfbQa_iconButton",
			"iconDanger": "fJfbQa_iconDanger",
			"inUse": "fJfbQa_inUse",
			"input": "fJfbQa_input",
			"intro": "fJfbQa_intro",
			"revealedPath": "fJfbQa_revealedPath",
			"revealedPathLabel": "fJfbQa_revealedPathLabel",
			"secondaryButton": "fJfbQa_secondaryButton",
			"section": "fJfbQa_section",
			"title": "fJfbQa_title",
			"viewerCode": "fJfbQa_viewerCode"
		};
		//#endregion
