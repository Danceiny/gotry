window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".MdyIRa_projectRow,.MdyIRa_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.MdyIRa_projectRow:hover,.MdyIRa_sessionRow:hover,.MdyIRa_sessionRow.MdyIRa_selected{background:var(--dsw-alias-interactive-bg-hover)}.MdyIRa_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.MdyIRa_searchResultRow:hover,.MdyIRa_searchResultRow.MdyIRa_selected{background:var(--dsw-alias-interactive-bg-hover)}.MdyIRa_searchResultHeading{align-items:center;min-width:0;display:flex}.MdyIRa_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.MdyIRa_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.MdyIRa_searchResultWorkspace,.MdyIRa_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.MdyIRa_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.MdyIRa_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.MdyIRa_projectRow{box-sizing:border-box;align-items:center;height:34px}.MdyIRa_projectRow .MdyIRa_rowActions{height:20px}.MdyIRa_sessionRow{height:32px;animation:MdyIRa_row-in .15s var(--ds-ease-in-out);gap:0}.MdyIRa_sessionRow .MdyIRa_title{margin:0 6px 0 4px}.MdyIRa_flatSessionRowWithoutStatus .MdyIRa_title{margin-left:0}@keyframes MdyIRa_row-in{0%{opacity:0}}.MdyIRa_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.MdyIRa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.MdyIRa_folderActive{color:var(--dsw-alias-state-business-primary)}.MdyIRa_projectRow .MdyIRa_chevron{display:none}.MdyIRa_projectRow:hover .MdyIRa_chevron{display:inline-flex}.MdyIRa_projectRow:hover .MdyIRa_folder{display:none}.MdyIRa_arrow{transition:transform .15s var(--ds-ease-in-out)}.MdyIRa_arrowOpen{transform:rotate(90deg)}.MdyIRa_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.MdyIRa_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.MdyIRa_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.MdyIRa_sessionRow .MdyIRa_title{flex:1}.MdyIRa_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.MdyIRa_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.MdyIRa_dot{flex:none}.MdyIRa_rowActions{flex:none;align-items:center;gap:12px;display:none}.MdyIRa_projectRow:hover .MdyIRa_rowActions,.MdyIRa_sessionRow:hover .MdyIRa_rowActions,.MdyIRa_projectRow.MdyIRa_menuOpen .MdyIRa_rowActions,.MdyIRa_sessionRow.MdyIRa_menuOpen .MdyIRa_rowActions{display:inline-flex}.MdyIRa_sessionRow:hover .MdyIRa_time,.MdyIRa_sessionRow.MdyIRa_menuOpen .MdyIRa_time{display:none}.MdyIRa_projectRow.MdyIRa_menuOpen,.MdyIRa_sessionRow.MdyIRa_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.MdyIRa_sessionRow.MdyIRa_dropBefore,.MdyIRa_sessionRow.MdyIRa_dropAfter{position:relative}.MdyIRa_sessionRow.MdyIRa_dropBefore:before,.MdyIRa_sessionRow.MdyIRa_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.MdyIRa_sessionRow.MdyIRa_dropBefore:before{top:-7px}.MdyIRa_sessionRow.MdyIRa_dropAfter:after{bottom:-7px}.MdyIRa_hoverContent{flex-direction:column;gap:8px;display:flex}.MdyIRa_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.MdyIRa_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.MdyIRa_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.MdyIRa_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.MdyIRa_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.MdyIRa_iconButton:hover{color:var(--dsw-alias-label-primary)}.MdyIRa_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.MdyIRa_sessionRow,.MdyIRa_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "MdyIRa_arrow",
			"arrowOpen": "MdyIRa_arrowOpen",
			"chevron": "MdyIRa_chevron",
			"dot": "MdyIRa_dot",
			"dropAfter": "MdyIRa_dropAfter",
			"dropBefore": "MdyIRa_dropBefore",
			"flatSessionRowWithoutStatus": "MdyIRa_flatSessionRowWithoutStatus",
			"folder": "MdyIRa_folder",
			"folderActive": "MdyIRa_folderActive",
			"hoverContent": "MdyIRa_hoverContent",
			"hoverPath": "MdyIRa_hoverPath",
			"hoverStatus": "MdyIRa_hoverStatus",
			"hoverTime": "MdyIRa_hoverTime",
			"hoverTitle": "MdyIRa_hoverTitle",
			"iconButton": "MdyIRa_iconButton",
			"menuOpen": "MdyIRa_menuOpen",
			"meta": "MdyIRa_meta",
			"projectRow": "MdyIRa_projectRow",
			"projectText": "MdyIRa_projectText",
			"renameInput": "MdyIRa_renameInput",
			"row-in": "MdyIRa_row-in",
			"rowActions": "MdyIRa_rowActions",
			"searchResultHeading": "MdyIRa_searchResultHeading",
			"searchResultMeta": "MdyIRa_searchResultMeta",
			"searchResultRow": "MdyIRa_searchResultRow",
			"searchResultSnippet": "MdyIRa_searchResultSnippet",
			"searchResultTitle": "MdyIRa_searchResultTitle",
			"searchResultWorkspace": "MdyIRa_searchResultWorkspace",
			"selected": "MdyIRa_selected",
			"sessionRow": "MdyIRa_sessionRow",
			"slot": "MdyIRa_slot",
			"time": "MdyIRa_time",
			"title": "MdyIRa_title",
			"visuallyHidden": "MdyIRa_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = "._6tc9fq_modalAction{min-width:72px}._6tc9fq_modalError,._6tc9fq_menuStatus{margin-top:8px;font-size:12px;line-height:18px}._6tc9fq_modalError{color:var(--dsw-alias-state-error-primary)}._6tc9fq_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "_6tc9fq_menuStatus",
			"modalAction": "_6tc9fq_modalAction",
			"modalError": "_6tc9fq_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-workspace/src/client/rows/WorkspaceBrowser.module.css.mjs
		const css = ".BZu2RW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.BZu2RW_root.BZu2RW_rail{padding-right:0}.BZu2RW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.BZu2RW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.BZu2RW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.BZu2RW_root:not(.BZu2RW_rail) .BZu2RW_sectionHeader{margin-top:2px;margin-right:-4px}.BZu2RW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.BZu2RW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.BZu2RW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.BZu2RW_searchSlotExpanded{max-width:100%;padding-left:0}.BZu2RW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.BZu2RW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.BZu2RW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.BZu2RW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.BZu2RW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.BZu2RW_searchExpanded .BZu2RW_searchButton{width:28px;height:30px}.BZu2RW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.BZu2RW_searchExpanded .BZu2RW_searchButton:hover{background:0 0}.BZu2RW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.BZu2RW_searchExpanded .BZu2RW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.BZu2RW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.BZu2RW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.BZu2RW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.BZu2RW_rail .BZu2RW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.BZu2RW_rail .BZu2RW_headerActions{max-width:none}.BZu2RW_rail .BZu2RW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.BZu2RW_rail .BZu2RW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.BZu2RW_rail .BZu2RW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.BZu2RW_rail .BZu2RW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.BZu2RW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.BZu2RW_rail .BZu2RW_listArea{margin-left:0;margin-right:0;padding-left:0}.BZu2RW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.BZu2RW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.BZu2RW_wide{animation:BZu2RW_wide-in .2s var(--ds-ease-in-out)}@keyframes BZu2RW_wide-in{0%{opacity:0}}.BZu2RW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.BZu2RW_flatList>*+*,.BZu2RW_searchTree>[role=treeitem]+[role=treeitem],.BZu2RW_groupSection>*+*{margin-top:2px}.BZu2RW_searchStatus,.BZu2RW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.BZu2RW_searchWarning{color:var(--dsw-alias-label-secondary)}.BZu2RW_groupSection{position:relative}.BZu2RW_groupSection+.BZu2RW_groupSection{margin-top:4px}.BZu2RW_listTopDropIndicator,.BZu2RW_workspaceDropBefore:before,.BZu2RW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.BZu2RW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.BZu2RW_listTopDropActive>.BZu2RW_workspaceDropBefore:first-child:before{display:none}.BZu2RW_workspaceDropBefore:before{top:-8px}.BZu2RW_workspaceDropAfter:after{bottom:-8px}.BZu2RW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.BZu2RW_groupSection>.BZu2RW_sessionOverflowButton{margin-top:0}.BZu2RW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.BZu2RW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.BZu2RW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.BZu2RW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.BZu2RW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.BZu2RW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.BZu2RW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.BZu2RW_wide{animation:none}.BZu2RW_search,.BZu2RW_sectionLabel,.BZu2RW_searchSlot,.BZu2RW_searchInput,.BZu2RW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "BZu2RW_clearButton",
			"deleteAction": "BZu2RW_deleteAction",
			"deleteStatus": "BZu2RW_deleteStatus",
			"empty": "BZu2RW_empty",
			"fade": "BZu2RW_fade",
			"flatList": "BZu2RW_flatList",
			"groupSection": "BZu2RW_groupSection",
			"headerActions": "BZu2RW_headerActions",
			"headerActionsHidden": "BZu2RW_headerActionsHidden",
			"iconButton": "BZu2RW_iconButton",
			"list": "BZu2RW_list",
			"listArea": "BZu2RW_listArea",
			"listTopDropActive": "BZu2RW_listTopDropActive",
			"listTopDropIndicator": "BZu2RW_listTopDropIndicator",
			"rail": "BZu2RW_rail",
			"renameError": "BZu2RW_renameError",
			"renameInput": "BZu2RW_renameInput",
			"root": "BZu2RW_root",
			"search": "BZu2RW_search",
			"searchButton": "BZu2RW_searchButton",
			"searchExpanded": "BZu2RW_searchExpanded",
			"searchInput": "BZu2RW_searchInput",
			"searchSlot": "BZu2RW_searchSlot",
			"searchSlotExpanded": "BZu2RW_searchSlotExpanded",
			"searchStatus": "BZu2RW_searchStatus",
			"searchTree": "BZu2RW_searchTree",
			"searchWarning": "BZu2RW_searchWarning",
			"sectionHeader": "BZu2RW_sectionHeader",
			"sectionLabel": "BZu2RW_sectionLabel",
			"sectionLabelHidden": "BZu2RW_sectionLabelHidden",
			"sessionOverflowButton": "BZu2RW_sessionOverflowButton",
			"treeBody": "BZu2RW_treeBody",
			"wide": "BZu2RW_wide",
			"wide-in": "BZu2RW_wide-in",
			"workspaceDropAfter": "BZu2RW_workspaceDropAfter",
			"workspaceDropBefore": "BZu2RW_workspaceDropBefore"
		};
		//#endregion
