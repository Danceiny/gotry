window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-subagent/src/client/SubagentHeaderLineage.module.css.mjs
		const css$1 = ".FFKaWG_root{align-items:center;gap:10px;min-width:0;display:inline-flex;position:relative}.FFKaWG_switcherRoot{min-width:0;margin-left:6px}.FFKaWG_trigger,.FFKaWG_switcherTrigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.FFKaWG_trigger{gap:4px}.FFKaWG_switcherTrigger{min-width:0;max-width:244px;color:var(--dsw-alias-label-primary);gap:4px;font-weight:500}.FFKaWG_ancestorSwitcherTrigger{color:var(--dsw-alias-label-tertiary);font-weight:400}.FFKaWG_switcherTitle{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.FFKaWG_switcherTrigger svg{flex:none}.FFKaWG_separator{color:var(--dsw-alias-label-caption);font-size:14px;line-height:20px}.FFKaWG_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.FFKaWG_trigger:hover,.FFKaWG_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.FFKaWG_switcherTrigger:hover,.FFKaWG_switcherTrigger:focus-visible{color:var(--dsw-alias-label-primary)}.FFKaWG_ancestorSwitcherTrigger:hover,.FFKaWG_ancestorSwitcherTrigger:focus-visible{color:var(--dsw-alias-label-tertiary)}.FFKaWG_trigger svg,.FFKaWG_switcherTrigger svg{transition:transform .12s}.FFKaWG_triggerOpen{transform:rotate(180deg)}.FFKaWG_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:fixed;overflow:auto}.FFKaWG_node{min-width:0;position:relative}.FFKaWG_menu>.FFKaWG_node{margin-left:-3px}.FFKaWG_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.FFKaWG_row:hover>.FFKaWG_clickarea,.FFKaWG_row:focus-visible>.FFKaWG_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.FFKaWG_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.FFKaWG_row>[data-state],.FFKaWG_clickarea>[data-state]{margin-top:4px}.FFKaWG_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.FFKaWG_disabled:hover{background:0 0}.FFKaWG_loadingRow{cursor:default}.FFKaWG_disclosure,.FFKaWG_disclosureSpace{flex:none;width:14px;height:18px}.FFKaWG_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.FFKaWG_disclosure:hover{color:var(--dsw-alias-label-primary)}.FFKaWG_disclosureOpen{transform:rotate(90deg)}.FFKaWG_content{flex-direction:column;flex:1;min-width:0;display:flex}.FFKaWG_label,.FFKaWG_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.FFKaWG_label{color:inherit;font-weight:400}.FFKaWG_currentLabel{font-weight:600}.FFKaWG_summary,.FFKaWG_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.FFKaWG_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.FFKaWG_metricToken{grid-row:1;line-height:18px}.FFKaWG_metricDuration{grid-row:2}.FFKaWG_children{margin-left:18px;padding-left:4px;position:relative}.FFKaWG_children:before,.FFKaWG_children>.FFKaWG_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.FFKaWG_children:before{height:26px;top:-26px}.FFKaWG_children[aria-busy=true]:before{content:none}.FFKaWG_children>.FFKaWG_node:before{top:0;bottom:0;left:-4px}.FFKaWG_children>.FFKaWG_node:last-child:before{height:17px;bottom:auto}.FFKaWG_children>.FFKaWG_node>.FFKaWG_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.FFKaWG_notice,.FFKaWG_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.FFKaWG_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.FFKaWG_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.FFKaWG_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentHeaderLineage_module_css_default = {
			"activitySlot": "FFKaWG_activitySlot",
			"ancestorSwitcherTrigger": "FFKaWG_ancestorSwitcherTrigger",
			"children": "FFKaWG_children",
			"clickarea": "FFKaWG_clickarea",
			"content": "FFKaWG_content",
			"currentLabel": "FFKaWG_currentLabel",
			"disabled": "FFKaWG_disabled",
			"disclosure": "FFKaWG_disclosure",
			"disclosureOpen": "FFKaWG_disclosureOpen",
			"disclosureSpace": "FFKaWG_disclosureSpace",
			"error": "FFKaWG_error",
			"label": "FFKaWG_label",
			"loadingRow": "FFKaWG_loadingRow",
			"menu": "FFKaWG_menu",
			"metricDuration": "FFKaWG_metricDuration",
			"metricToken": "FFKaWG_metricToken",
			"metrics": "FFKaWG_metrics",
			"node": "FFKaWG_node",
			"notice": "FFKaWG_notice",
			"refresh": "FFKaWG_refresh",
			"root": "FFKaWG_root",
			"row": "FFKaWG_row",
			"separator": "FFKaWG_separator",
			"summary": "FFKaWG_summary",
			"switcherRoot": "FFKaWG_switcherRoot",
			"switcherTitle": "FFKaWG_switcherTitle",
			"switcherTrigger": "FFKaWG_switcherTrigger",
			"trigger": "FFKaWG_trigger",
			"triggerOpen": "FFKaWG_triggerOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-subagent/src/client/SubagentReadOnlyComposer.module.css.mjs
		const css = ".RT9TBG_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.RT9TBG_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "RT9TBG_frame" };
		//#endregion
