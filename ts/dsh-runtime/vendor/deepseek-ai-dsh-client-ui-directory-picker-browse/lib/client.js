window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/client/ui-directory-picker-browse/src/client/DirectoryBrowser.module.css.mjs
		const css = ".LwW6Kq_dialog.LwW6Kq_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.LwW6Kq_editorScope{display:contents}.LwW6Kq_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.LwW6Kq_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.LwW6Kq_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.LwW6Kq_crumbBar:has(.LwW6Kq_crumbEditZone:enabled:hover),.LwW6Kq_crumbBar:has(.LwW6Kq_crumbEditZone:focus-visible),.LwW6Kq_crumbBar:has(.LwW6Kq_pathInput){border-color:var(--dsw-alias-border-l2)}.LwW6Kq_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.LwW6Kq_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.LwW6Kq_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.LwW6Kq_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.LwW6Kq_crumb:hover{color:var(--dsw-alias-label-primary)}.LwW6Kq_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.LwW6Kq_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.LwW6Kq_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.LwW6Kq_crumbEditZone:enabled:hover .LwW6Kq_crumbEditGlyph,.LwW6Kq_crumbEditZone:focus-visible .LwW6Kq_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.LwW6Kq_crumbEditZone:disabled{cursor:default}.LwW6Kq_crumbEditZone:disabled .LwW6Kq_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.LwW6Kq_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.LwW6Kq_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.LwW6Kq_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.LwW6Kq_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.LwW6Kq_rowSeat{flex:none;display:flex}.LwW6Kq_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.LwW6Kq_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.LwW6Kq_rowSelected,.LwW6Kq_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.LwW6Kq_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.LwW6Kq_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.LwW6Kq_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.LwW6Kq_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.LwW6Kq_status,.LwW6Kq_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.LwW6Kq_status{color:var(--dsw-alias-label-secondary)}.LwW6Kq_error{color:var(--dsw-alias-state-error-primary)}.LwW6Kq_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.LwW6Kq_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.LwW6Kq_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.LwW6Kq_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.LwW6Kq_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.LwW6Kq_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.LwW6Kq_footerGap{flex:1 1 0}.LwW6Kq_footerAction{min-width:72px}.LwW6Kq_createDialog.LwW6Kq_createDialog{gap:0;width:min(380px,100%);padding:0}.LwW6Kq_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.LwW6Kq_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.LwW6Kq_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.LwW6Kq_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.LwW6Kq_createInput::placeholder{color:var(--dsw-alias-label-caption)}.LwW6Kq_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "LwW6Kq_column",
			"content": "LwW6Kq_content",
			"createActions": "LwW6Kq_createActions",
			"createBody": "LwW6Kq_createBody",
			"createDialog": "LwW6Kq_createDialog",
			"createIn": "LwW6Kq_createIn",
			"createInput": "LwW6Kq_createInput",
			"createTitle": "LwW6Kq_createTitle",
			"crumb": "LwW6Kq_crumb",
			"crumbBar": "LwW6Kq_crumbBar",
			"crumbChevron": "LwW6Kq_crumbChevron",
			"crumbEditGlyph": "LwW6Kq_crumbEditGlyph",
			"crumbEditZone": "LwW6Kq_crumbEditZone",
			"crumbSeat": "LwW6Kq_crumbSeat",
			"crumbTrail": "LwW6Kq_crumbTrail",
			"dialog": "LwW6Kq_dialog",
			"divider": "LwW6Kq_divider",
			"editorScope": "LwW6Kq_editorScope",
			"error": "LwW6Kq_error",
			"footerAction": "LwW6Kq_footerAction",
			"footerBar": "LwW6Kq_footerBar",
			"footerGap": "LwW6Kq_footerGap",
			"header": "LwW6Kq_header",
			"loadingFloat": "LwW6Kq_loadingFloat",
			"millerRow": "LwW6Kq_millerRow",
			"pathInput": "LwW6Kq_pathInput",
			"row": "LwW6Kq_row",
			"rowChevron": "LwW6Kq_rowChevron",
			"rowIcon": "LwW6Kq_rowIcon",
			"rowIconSelected": "LwW6Kq_rowIconSelected",
			"rowName": "LwW6Kq_rowName",
			"rowSeat": "LwW6Kq_rowSeat",
			"rowSelected": "LwW6Kq_rowSelected",
			"showHiddenToggle": "LwW6Kq_showHiddenToggle",
			"showHiddenToggleActive": "LwW6Kq_showHiddenToggleActive",
			"status": "LwW6Kq_status",
			"title": "LwW6Kq_title"
		};
		//#endregion
