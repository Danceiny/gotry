window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = ".oZJbMa_card{flex-direction:column;gap:8px;display:flex}.oZJbMa_row{align-items:center;min-height:32px;display:flex}.oZJbMa_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.oZJbMa_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.oZJbMa_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.oZJbMa_summary,.oZJbMa_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.oZJbMa_error{color:var(--dsw-alias-state-error-primary)}.oZJbMa_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.oZJbMa_card[data-cordis-status=awaiting-approval] .oZJbMa_status,.oZJbMa_card[data-cordis-status=client-pending] .oZJbMa_status{color:var(--dsw-alias-state-warn-label)}.oZJbMa_card[data-cordis-status=running] .oZJbMa_status{color:var(--dsw-alias-state-success-primary)}.oZJbMa_card[data-cordis-status=failed] .oZJbMa_status{color:var(--dsw-alias-state-error-primary)}.oZJbMa_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.oZJbMa_card:hover .oZJbMa_inspect,.oZJbMa_inspect:focus-visible{opacity:1}.oZJbMa_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.oZJbMa_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.oZJbMa_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.oZJbMa_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.oZJbMa_business .oZJbMa_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"business": "oZJbMa_business",
			"card": "oZJbMa_card",
			"error": "oZJbMa_error",
			"icon": "oZJbMa_icon",
			"inspect": "oZJbMa_inspect",
			"message": "oZJbMa_message",
			"output": "oZJbMa_output",
			"row": "oZJbMa_row",
			"separator": "oZJbMa_separator",
			"status": "oZJbMa_status",
			"summary": "oZJbMa_summary",
			"title": "oZJbMa_title"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".ulPomG_card{flex-direction:column;display:flex}.ulPomG_card .ulPomG_title,.ulPomG_card .ulPomG_chevron{color:var(--dsw-alias-state-business-primary)}.ulPomG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.ulPomG_row{gap:0}.ulPomG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.ulPomG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.ulPomG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.ulPomG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.ulPomG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.ulPomG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.ulPomG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.ulPomG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.ulPomG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.ulPomG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.ulPomG_switch{height:22px;padding:0 8px;font-size:12px}.ulPomG_card[data-terminal] .ulPomG_title,.ulPomG_card[data-terminal] .ulPomG_name,.ulPomG_card[data-terminal] .ulPomG_purpose,.ulPomG_card[data-terminal] .ulPomG_statusLabel{color:var(--dsw-alias-label-caption)}.ulPomG_card[data-terminal] .ulPomG_separator{background:var(--dsw-alias-label-caption)}.ulPomG_bodyWrap{flex-direction:column;display:flex}.ulPomG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.ulPomG_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.ulPomG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.ulPomG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.ulPomG_sourceTab:disabled{cursor:default;opacity:.4}.ulPomG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.ulPomG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.ulPomG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.ulPomG_sourcePanel{max-height:260px;overflow:auto}.ulPomG_sourceCode{margin:0}.ulPomG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.ulPomG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.ulPomG_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.ulPomG_output[data-error]{color:var(--dsw-alias-state-error-primary)}.ulPomG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.ulPomG_card:hover .ulPomG_inspectButton,.ulPomG_inspectButton:focus-visible{opacity:1}.ulPomG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.ulPomG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.ulPomG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"approvalPrompt": "ulPomG_approvalPrompt",
			"bodyWrap": "ulPomG_bodyWrap",
			"card": "ulPomG_card",
			"chevron": "ulPomG_chevron",
			"codeSection": "ulPomG_codeSection",
			"errorSummary": "ulPomG_errorSummary",
			"inspectButton": "ulPomG_inspectButton",
			"name": "ulPomG_name",
			"notice": "ulPomG_notice",
			"output": "ulPomG_output",
			"panelHint": "ulPomG_panelHint",
			"purpose": "ulPomG_purpose",
			"readout": "ulPomG_readout",
			"requestError": "ulPomG_requestError",
			"row": "ulPomG_row",
			"sectionLabel": "ulPomG_sectionLabel",
			"separator": "ulPomG_separator",
			"sourceCard": "ulPomG_sourceCard",
			"sourceCode": "ulPomG_sourceCode",
			"sourcePanel": "ulPomG_sourcePanel",
			"sourceTab": "ulPomG_sourceTab",
			"sourceTabActive": "ulPomG_sourceTabActive",
			"sourceTabs": "ulPomG_sourceTabs",
			"statusLabel": "ulPomG_statusLabel",
			"switch": "ulPomG_switch",
			"title": "ulPomG_title",
			"visuallyHidden": "ulPomG_visuallyHidden"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/private/tmp/dsh-alpha/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".dS8U4a_layer{flex:none;align-items:center;width:100%;height:42px;margin:8px 0 0;display:flex;position:relative}.dS8U4a_footerButtons{align-items:center;width:100%;display:flex}.dS8U4a_badge{width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;margin:0 -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.dS8U4a_badge:hover,.dS8U4a_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.dS8U4a_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.dS8U4a_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.dS8U4a_layer.dS8U4a_rail{width:36px;height:36px;margin:0}.dS8U4a_rail .dS8U4a_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.dS8U4a_rail .dS8U4a_footerButtons{flex-direction:column;gap:2px}.dS8U4a_panel{z-index:30;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;overflow:hidden}.dS8U4a_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.dS8U4a_body{flex:1;min-height:0;padding:0 12px 12px;overflow-y:auto}.dS8U4a_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:20px}.dS8U4a_note,.dS8U4a_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.dS8U4a_readError{color:var(--dsw-alias-state-error-primary)}.dS8U4a_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0;font-size:11px;font-weight:500;line-height:16px}.dS8U4a_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.dS8U4a_row{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;flex-direction:column;gap:8px;padding:14px 12px 10px;display:flex}.dS8U4a_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.dS8U4a_rowHead{align-items:center;gap:8px;display:flex}.dS8U4a_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.dS8U4a_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.dS8U4a_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.dS8U4a_row[data-cordis-status=idle] .dS8U4a_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.dS8U4a_row[data-cordis-status=awaiting-approval] .dS8U4a_rowStatus,.dS8U4a_row[data-cordis-status=client-pending] .dS8U4a_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.dS8U4a_row[data-cordis-status=failed] .dS8U4a_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.dS8U4a_row[data-cordis-status=running] .dS8U4a_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.dS8U4a_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.dS8U4a_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.dS8U4a_versionPicker select{border:1px solid var(--dsw-alias-border-l2);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;background:0 0;border-radius:7px;flex:1;padding:0 8px}.dS8U4a_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.dS8U4a_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.dS8U4a_rowActions{flex:none;align-items:center;gap:10px;display:flex}.dS8U4a_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.dS8U4a_transitionActions{gap:6px;margin-left:auto;display:flex}.dS8U4a_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.dS8U4a_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.dS8U4a_transitionActions button:disabled{opacity:.4;cursor:default}.dS8U4a_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.dS8U4a_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.dS8U4a_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.dS8U4a_actionButton:disabled{opacity:.4;cursor:default}.dS8U4a_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.dS8U4a_doubleCheck svg{position:absolute;top:1px}.dS8U4a_doubleCheck svg:first-child{opacity:.7;left:0}.dS8U4a_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"actionButton": "dS8U4a_actionButton",
			"activeVersion": "dS8U4a_activeVersion",
			"badge": "dS8U4a_badge",
			"badgeCount": "dS8U4a_badgeCount",
			"badgeLabel": "dS8U4a_badgeLabel",
			"body": "dS8U4a_body",
			"doubleCheck": "dS8U4a_doubleCheck",
			"footerButtons": "dS8U4a_footerButtons",
			"group": "dS8U4a_group",
			"header": "dS8U4a_header",
			"layer": "dS8U4a_layer",
			"note": "dS8U4a_note",
			"panel": "dS8U4a_panel",
			"rail": "dS8U4a_rail",
			"readError": "dS8U4a_readError",
			"row": "dS8U4a_row",
			"rowActions": "dS8U4a_rowActions",
			"rowDetail": "dS8U4a_rowDetail",
			"rowError": "dS8U4a_rowError",
			"rowHead": "dS8U4a_rowHead",
			"rowId": "dS8U4a_rowId",
			"rowName": "dS8U4a_rowName",
			"rowPurpose": "dS8U4a_rowPurpose",
			"rowStatus": "dS8U4a_rowStatus",
			"rows": "dS8U4a_rows",
			"title": "dS8U4a_title",
			"transition": "dS8U4a_transition",
			"transitionActions": "dS8U4a_transitionActions",
			"versionPicker": "dS8U4a_versionPicker"
		};
		//#endregion
